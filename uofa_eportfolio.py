...
COURSES = [
            {
                ...
                "grade": "A",
                "skills": ["Directed Research", "Parameter-Efficient Fine-Tuning (PEFT, LoRA)","Transfer Learning", "Post-Training Adaptation", "Foundation Music Models & Music Generation", "Multimodal Language Models", "Generative AI", "Transformer Architectures", "Autoregressive Language Models", "Audio Tokenization", "Residual Vector Quantization (EnCodec/RVQ)", "Audio Feature Engineering (Mel, MFCC, Chroma, Onset)", "PyTorch", "Hugging Face Transformers", "Meta AudioCraft", "End-to-End ML Pipeline Engineering", "User Perceptual Evaluation & A/B Testing", "Statistical Analysis (Holm-corrected binomial hypothesis tests)","Streamlit Web App", "Google Cloud APIs (Sheets/Drive)", "Reproducible ML Research"],
                "project":{
